...
template <> struct ConversionVisitor<iso20_ac_AC_ChargeParameterDiscoveryResType> {
public:
    ConversionVisitor(iso20_ac_AC_ChargeParameterDiscoveryResType& res_) : res(res_){};
