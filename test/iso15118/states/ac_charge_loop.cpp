...
SCENARIO("AC charge loop state handling") {
    ...
    GIVEN("Bad case - Unknown session") {
        ...
        const auto res = d20::state::handle_request(req, d20::Session(), false, 50, d20::AcTargetPower(),
    ...
    GIVEN("Good case - AC scheduled mode") {
        ...
        const auto res = d20::state::handle_request(req, session, false, 50, ac_target_power, ac_present_power,
    ...
    GIVEN("Good case - AC dynamic mode, mobility_needs_mode = 2") {
        ...
        const auto res =
            d20::state::handle_request(req, session, false, 50, ac_target_power, ac_present_power, dynamic_parameters);
