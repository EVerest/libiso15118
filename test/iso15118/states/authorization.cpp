...
using AuthStatus = datatypes::AuthStatus;
...
SCENARIO("Authorization state handling") {
    ...
    GIVEN("Bad Case - Unknown session") {
        ...
        req.selected_authorization_service = datatypes::Authorization::EIM;
        req.authorization_mode.emplace<datatypes::EIM_ASReqAuthorizationMode>();
        ...
        THEN("ResponseCode: FAILED_UnknownSession, mandatory fields should be set") {
            ...
            REQUIRE(res.evse_processing == datatypes::Processing::Finished);
        }
    }
    ...
    GIVEN("Warning - Authorization selection is invalid") {
        ...
        d20::Session session = d20::Session();
        session.offered_services.auth_services = {datatypes::Authorization::PnC};
        ...
        THEN("ResponseCode: FAILED_UnknownSession, EvseProcessing: Finished") {
            REQUIRE(res.response_code == datatypes::ResponseCode::WARNING_AuthorizationSelectionInvalid);
            REQUIRE(res.evse_processing == datatypes::Processing::Finished);
        }
    }
    ...
    GIVEN("Warning - EIM Authorization Failure") { // [V2G20-2219]
        ...
        d20::Session session = d20::Session();
        session.offered_services.auth_services = {datatypes::Authorization::EIM, datatypes::Authorization::PnC};
        ...
        THEN("ResponseCode: WARNING_EIMAuthorizationFailure, EvseProcessing: Finished") {
            REQUIRE(res.response_code == datatypes::ResponseCode::WARNING_EIMAuthorizationFailure);
            REQUIRE(res.evse_processing == datatypes::Processing::Finished);
        }
    }
    ...
    GIVEN("Good case - EIM waiting for authorization") {
        ...
        THEN("ResponseCode: Ok, EvseProcessing: Ongoing") {
            ...
            REQUIRE(res.evse_processing == datatypes::Processing::Ongoing);
        }
    }
